...
library("papaja") #fyi use 'papaja::apa6_docx' for knitting a pdf
...
parentfolder <- "D:/Research_Projects/Respiration, Gesture, Speech/MainStudy_fluidspeech/GIT_GS_PhysicsFluidSpeech/GSPhysics_fluid_speech/MS_markdown" 
...
fd$time_voc <- ifelse(is.finite(fd$time_voc), NA, fd$time_voc)             #ignore infinites that are produced for our missing timing data
